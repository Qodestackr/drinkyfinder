...
const BarsPage = () => {
    ...
    return (
        <App width="full" maxWidth="1280px" mx="auto" px={6} py={6}>
            ...
            {/*!data ? (
                ...
                <>
                    ...
                    <Flex justify="flex-end" as="i" color="gray.500">
                        {`Showing ${filteredLocations.length} out of ${allLocations.length} bars in Nairobi`}
                    </Flex>
                </>
            )*/}
            <Flex pt={24} align="center" justify="center">
            ...
            <BarCard key={"bar.id"}/>
            <Flex justify="flex-end" as="i" color="gray.500">
               {`Showing ${/*filteredLocations.length*/ 8} out of ${15/*allLocations.length*/} bars in Nairobi`}
            </Flex>
        </App>
    );
};
